                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p class="card-text" style="display: inline;">{{ $documents['name']}}</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Price:</h6>
                                    <p class="card-text" style="display: inline;">RM{{ $documents['price']}}</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">District:</h6>
                                    <p class="card-text" style="display: inline;">{{ $documents['district'] }}</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Type:</h6>
                                    <p class="card-text" style="display: inline;">{{ $documents['type'] }}</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Maximum Person per House:</h6>
                                    <p class="card-text" style="display: inline;">{{ $documents['max'] }}</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Quota:</h6>
                                    <p class="card-text" style="display: inline;">{{ $documents['quota'] }}</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Preferred Gender:</h6>
                                    <p class="card-text" style="display: inline;">{{ $documents['preffered gender'] }}</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Owner:</h6>
                                    <a href="{{ route('landlord.show', ['id' => $documents['owner']]) }}" style="display: inline;">
                                        <i class="fas fa-user-circle"></i>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="card-subtitle" style="display: inline;">Location:</h6>
                                    <a href="{{ route('map.show', ['id' => $documents->id()]) }}" style="display: inline;">
